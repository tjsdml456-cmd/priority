...
template <>
struct formatter<srsran::security::integrity_algorithm> {
  ...
  auto format(srsran::security::integrity_algorithm algo, FormatContext& ctx) const
  {
...
template <>
struct formatter<srsran::security::ciphering_algorithm> {
  template <typename ParseContext>
  constexpr auto parse(ParseContext& ctx)
  {
    return ctx.begin();
  ...
  template <typename FormatContext>
  auto format(srsran::security::ciphering_algorithm algo, FormatContext& ctx) const
  {
    return format_to(ctx.out(), "{}", fmt::underlying(algo));
  }
};
...
struct formatter<srsran::security::security_direction> {
  ...
  template <typename FormatContext>
  auto format(srsran::security::security_direction dir, FormatContext& ctx) const
  {
...
struct formatter<srsran::security::integrity_enabled> {
  ...
  template <typename FormatContext>
  auto format(srsran::security::integrity_enabled integrity_flag, FormatContext& ctx) const
  {
...
struct formatter<srsran::security::ciphering_enabled> {
  ...
  template <typename FormatContext>
  auto format(srsran::security::ciphering_enabled ciphering_flag, FormatContext& ctx) const
  {
    static constexpr const char* options[] = {"off", "on"};
...
struct formatter<srsran::security::supported_algorithms> {
  ...
  template <typename FormatContext>
  auto format(srsran::security::supported_algorithms algos, FormatContext& ctx) const
  {
...
struct formatter<srsran::security::preferred_integrity_algorithms> {
  ...
  template <typename FormatContext>
  auto format(const srsran::security::preferred_integrity_algorithms& algos, FormatContext& ctx) const
  {
...
struct formatter<srsran::security::preferred_ciphering_algorithms> {
  ...
  template <typename FormatContext>
  auto format(const srsran::security::preferred_ciphering_algorithms& algos, FormatContext& ctx) const
  {
    return format_to(ctx.out(),
                     "NEA{}, NEA{}, NEA{}, NEA{}",
                     fmt::underlying(algos[0]),
...
struct formatter<srsran::security::sec_domain> {
  ...
  template <typename FormatContext>
  auto format(srsran::security::sec_domain domain, FormatContext& ctx) const
  {
...
struct formatter<srsran::security::sec_128_key> {
  ...
  template <typename FormatContext>
  auto format(const srsran::security::sec_128_key& key, FormatContext& ctx) const
  {
    return format_to(ctx.out(), "\n\t{:02x}", fmt::join(key, " "));
  }
};
...
struct formatter<srsran::security::sec_key> {
  ...
  template <typename FormatContext>
  auto format(const srsran::security::sec_key& key, FormatContext& ctx) const
  {
...
struct formatter<srsran::security::sec_mac> {
  ...
  template <typename FormatContext>
  auto format(const srsran::security::sec_mac& mac, FormatContext& ctx) const
  {
    return format_to(ctx.out(), "\n\t{:02x}", fmt::join(mac, " "));
  }
};
