...
std::vector<nia_test_set> nia2_test_set = {
    nia_test_set{
        .name         = "128_NIA2_Test_Set_1_mod",
        .count_i      = 0x38a6f056,
        .bearer       = 0x18,
        .direction    = 0,
        .ik_cstr      = "2bd6459f82c5b300952c49104881ff48",
        .length       = 64,
        .message_cstr = "3332346263393840",
        .mact_cstr    = "c28458e9",
    },
    nia_test_set{
        .name         = "128_NIA2_Test_Set_2",
        .count_i      = 0x398a59b4,
        .bearer       = 0x1a,
        .direction    = 1,
        .ik_cstr      = "d3c5d592327fb11c4035c6680af8c6d1",
        .length       = 64,
        .message_cstr = "484583d5afe082ae",
        .mact_cstr    = "b93787e6",
    },
    nia_test_set{
        .name         = "128_NIA2_Test_Set_3_mod",
        .count_i      = 0x36af6144,
        .bearer       = 0x18,
        .direction    = 1,
