...
using PucchProcessorF4Fixture    = PucchProcessorTestFixture<PucchProcessorFormat4Param>;
template <>
std::unique_ptr<pucch_processor> PucchProcessorF4Fixture::processor = nullptr;
template <>
std::unique_ptr<pucch_pdu_validator> PucchProcessorF4Fixture::validator = nullptr;
