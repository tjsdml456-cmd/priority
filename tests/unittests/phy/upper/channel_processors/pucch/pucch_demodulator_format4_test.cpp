...
{
  fmt::print(os,
             "ports=[{}] first_prb={} second_hop_prb={} start_symbol_index={} nof_symbols={} rnti={} "
             "n_id={} additionalDMRS={} pi2_bpsk={} spreading_factor={} occi={}",
             ...
             test_case.context.config.occ_length,
             test_case.context.config.occ_index);
  return os;
}
...
INSTANTIATE_TEST_SUITE_P(PucchDemodulatorVectorTest,
                         ...
                         ::testing::ValuesIn(pucch_demodulator_format4_test_data));
