...
/// \brief LDPC Rate dematcher specialized with AVX2 instruction set.
///
/// It implements \ref ldpc_rate_dematcher interface. It relies on AVX and AVX2 instruction sets.
class ldpc_rate_dematcher_avx2_impl : public ldpc_rate_dematcher_impl
{
protected:
